  ...
  def get_scores(questions)
    ...
    self.participants.each{
      ...
      questionnaires.each{
        ...
        scores[:participants][participant.id.to_s.to_sym][questionnaire.symbol][:scores] = Score.compute_scores_statistics(scores[:participants][participant.id.to_s.to_sym][questionnaire.symbol][:assessments], questions[questionnaire.symbol])
    ...
    if self.team_assignment
      ...
      self.teams.each{
        ...
        scores[:teams][index.to_s.to_sym][:scores] = Score.compute_scores_statistics(assessments, questions[:review])
